<?php
    ...
    if (isset($_POST['addArea'])) {
        $areaName = $_POST['areaName'];
            ...
            $insertQuery = mysqli_query($connect, "INSERT INTO phone_numbers(phone_number)VALUES('$areaName')");
            if (!$insertQuery) {
                    ...
                    <div class="card-body">
                        <form method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control check" placeholder="Area" type="number" maxlength="11" value="03" id="example-text-input" name="areaName" required="">
                                </div>
                            </div><hr>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12" align="right">
                                    ...
                                    <button type="submit" id="btn" class="btn btn-primary waves-effect waves-light" name="addArea">Add Area</button>
                                </div>
                            </div>
                        </form>
