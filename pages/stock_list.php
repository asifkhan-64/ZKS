                            ...
                            <tbody>
                                ...
                                while ($rowMobiles = mysqli_fetch_assoc($retMobiles)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="stock_edit.php?id='.$rowMobiles['st_id'].'" type="button" class="btn text-white btn-warning waves-effect waves-light">Edit</a></td>
                                    </tr>
                                    ';
                                }
                                ?>
