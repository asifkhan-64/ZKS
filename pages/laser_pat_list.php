...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title">Laser Patients List</h5>
            </div>
        </div>
        <!-- end row -->
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <h4 class="mt-0 header-title text-center">Laser Patients List</h4>
                                    ...
                                    echo '
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="laser_pat_edit.php?id='.$rowPatients['id'].'" type="button" class="btn text-white btn-primary waves-effect waves-light btn-sm">Edit&nbsp;&nbsp;<i class="fa fa-pencil"></i></a>
                                            </td>

                                            <td class="text-center">
                                                <a href="laser_charges.php?id='.$rowPatients['id'].'" type="button" class="btn text-white btn-success waves-effect waves-light btn-sm">Charges&nbsp;&nbsp;<i class="fa fa-dollar"></i></a>
                                            </td>
                                        </tr>';
                                        }
                                    }
