...
<div class="page-content-wrapper" id="colorId">
    <div class="container-fluid"><br>
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title d-inline" >Expense Slip</h5>
                    ...
                    <div class="card-body" id="printElement" >
                            ...
                            <div class="col-12" style="margin-top: -10px !important;">
                                <div class="invoice-title text-center">
                                    <h3 class="m-t-0 m-b-0 text-center">
                                        ...
                                        <h3 align="center" style="font-size: 15px; font-weight: bold">Expense Slip</h3>
                                    </h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" align="center">
                            <div class="col-md-12">
                                ...
                                <?php
                                    $retExpense = mysqli_query($connect, "SELECT * FROM expense WHERE expense_date LIKE '%$currentDate%'");


                                    while ($rowExpense = mysqli_fetch_assoc($retExpense)) {
                                        echo '
                                        <label style="font-size: 12px; font-weight: bold">
                                            '.$rowExpense['expense_description'].':
                                        </label>

                                        <span style="font-size: 12px; font-weight: bold">
                                            '.$rowExpense['expense_amount'].'
                                        </span><br><br>
                                ...
                                <h1 align="center" style="font-size: 14px; margin-top: -10px; margin-bottom: -10px;">
                                    <?php
                                        ...
                                        if (!empty($sumExpenseFetch['expenseAllAmount'])) {
                                            echo "Total: ".$sumExpenseFetch['expenseAllAmount'];
                                        }else {
                                            echo "Total: 0";
                                        }
