<?php
    ...
    $selectCustomer = mysqli_query($connect, "SELECT laser_patient.*, area.area_name, case_tbl.case_name FROM `laser_patient`
                                    INNER JOIN area ON area.id = laser_patient.address_city
                                    INNER JOIN case_tbl ON case_tbl.id = laser_patient.patient_laser
                                    WHERE laser_patient.id = '$id'");
                        ...
                        <!-- <div class="row"> -->
                            <div class="col-md-12">
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                      <tr align="center">
                                        <td style="font-size: 12px; font-weight: bold;"><?php echo $fetch_selectCustomer['case_name'] ?></td>
                                      </tr>                                  
                                    </tbody>
                                </table>
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                      ...
                                      <tr>
                                        <td style="font-size: 12px; font-weight: bold; border: 1px solid black; ">Laser Machine Charges</td>
                                        <td style="font-size: 12px; font-weight: bold; border: 1px solid black;">Rs. <?php echo $fetch_selectCustomer['laser_charges'] ?></td>
                                      </tr>

                                      <tr>
                                        <td style="font-size: 12px; font-weight: bold; border: 1px solid black; ">Anesthesia Charges</td>
                                        <td style="font-size: 12px; font-weight: bold; border: 1px solid black;">Rs. <?php echo $fetch_selectCustomer['anes_charges'] ?></td>
                                      </tr>

                                      

                                      <?php
                                        $totalCharges = $fetch_selectCustomer['dr_charges'] + $fetch_selectCustomer['laser_charges'] + $fetch_selectCustomer['anes_charges'];
                                       ?>
                                      <tr>
