...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title">Add Laser Patient</h5>
            </div>
        </div>
                        ...
                        <form method="POST">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10">
                                    ...
                                    <button type="submit" name="patientRegister" class="btn btn-primary waves-effect waves-light">Add Laser Patient</button>
                                </div>
                            </div>
