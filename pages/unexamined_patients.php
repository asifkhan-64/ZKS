                        ...
                        <table id="datatablesCurrent" class="table  dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                $selectQueryPatients = mysqli_query($connect, "SELECT patient_registration.*, area.area_name FROM `patient_registration`
                                    ...
                                    WHERE patient_registration.pat_status = '0' AND patient_registration.DateOfAdmission LIKE '%$date%'
                                    ...
                                    echo '
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="patient_fee.php?id='.$rowPatients['id'].'" type="button" class="btn text-white btn-success waves-effect waves-light btn-sm">Fee Edit</a>
                                            </td>

                                            <td class="text-center">
                                                <a href="patient_view.php?id='.$rowPatients['id'].'" type="button" class="btn text-white btn-info waves-effect waves-light btn-sm">View&nbsp;&nbsp;<i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>';
                                        }
